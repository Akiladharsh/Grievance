...
} elseif ($_instance->childHasBeenRendered('XeueanB')) {
    $componentId = $_instance->getRenderedChildComponentId('XeueanB');
    $componentTag = $_instance->getRenderedChildComponentTagName('XeueanB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XeueanB');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('XeueanB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('QRJnRUb')) {
    $componentId = $_instance->getRenderedChildComponentId('QRJnRUb');
    $componentTag = $_instance->getRenderedChildComponentTagName('QRJnRUb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QRJnRUb');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('QRJnRUb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
