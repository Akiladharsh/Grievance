...
} elseif ($_instance->childHasBeenRendered('gb95GkE')) {
    $componentId = $_instance->getRenderedChildComponentId('gb95GkE');
    $componentTag = $_instance->getRenderedChildComponentTagName('gb95GkE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gb95GkE');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('gb95GkE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
